# work log
# enhanced the encryption method by adding a password.
# adding selection feature to grab timestamps
# append entry logic working.
# working on update entry logic.
# adding scrollbar to datepicker
# adding days since last entry counter.
...
# Fx to display number of days since an entry was made.
...
root.title("Encrypted Journal")  # Set the title of the window
...
text_entry = tk.Text(text_frame, wrap=tk.WORD, width=50, height=20, bg='lightyellow')
text_entry.pack()
...
days_since_label = tk.Label(root, text=days_since_last_entry(), bg='lightgrey')
